...
def zk(
    ...
    entry_new = icon_menu + " create a new note "
    entry_new_fleeting = icon_menu + " create a fleeting note "
    entry_new_daily = icon_menu + " create a daily note "
    entry_new_monthly = icon_menu + " create a monthly note "
    entry_all_notes = icon_menu + " show all notes "
    entry_all_fleeting = icon_menu + " show all fleeting notes "
    entry_all_daily = icon_menu + " show all daily notes "
    entry_all_monthly = icon_menu + " show all monthly notes "
